...
[DependsOn(
    ...
    typeof(BookStorePdfHttpApiModule),
...
public class BookStorePdfBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(BookStorePdfResource),
                typeof(BookStorePdfDomainModule).Assembly,
                typeof(BookStorePdfDomainSharedModule).Assembly,
                typeof(BookStorePdfApplicationModule).Assembly,
                typeof(BookStorePdfApplicationContractsModule).Assembly,
                typeof(BookStorePdfBlazorModule).Assembly
            );
        });
    }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/BookStorePdf.Blazor.styles.css");
                }
            );
        });
    }
    ...
    private void ConfigureSwaggerServices(IServiceCollection services)
    {
        services.AddAbpSwaggerGen(
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "BookStorePdf API", Version = "v1" });
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new BookStorePdfMenuContributor());
        });
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(BookStorePdfBlazorModule).Assembly;
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(BookStorePdfApplicationModule).Assembly);
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<BookStorePdfBlazorModule>();
        });
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "BookStorePdf API");
        });
